<template>
    <div id="domen_root">
        ...
        <p>
            ...
            когда выражение 2*Y + 2 выходит за пределы своих возможных значений, т.е. становится = 2<sup>31</sup> =
            -2<sup>31</sup><br>
        ...
        Также напишите где-нибудь, что тесты не должны попадать на прямую Х = 0. Ну и на графике это отметьте, разумеется.
        <br>
        <br>
